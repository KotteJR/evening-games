...
export function PlayerIndicator({
  ...
  return (
    <header
      className="flex w-full max-w-phone mx-auto items-center justify-between border-b border-border px-1 py-3 font-mono text-[10px] uppercase tracking-[0.1em]"
      aria-live="polite"
    >
      <div
        className={`text-left ${p1Active ? "text-white" : "text-muted"}`}
      ...
      <div
        className={`text-right ${p2Active ? "text-white" : "text-muted"}`}
